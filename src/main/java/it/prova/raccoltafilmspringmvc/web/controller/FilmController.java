...
public class FilmController {
	...
	@PostMapping("/list")
	public String listFilms(FilmDTO filmExample, @RequestParam(defaultValue = "0") Integer pageNo,
			@RequestParam(defaultValue = "10") Integer pageSize, @RequestParam(defaultValue = "id") String sortBy,
			ModelMap model) {
		
		List<Film> films = filmService.findByExampleWithPagination(filmExample.buildFilmModel(), pageNo,
	...
	@PostMapping("/elimina")
	public String eliminaFilm(@RequestParam(name = "idFilm") Long idFilm,
			RedirectAttributes redirectAttrs, HttpServletRequest request) {
