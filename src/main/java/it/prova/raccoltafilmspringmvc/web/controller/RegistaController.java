...
public class RegistaController {
	...
	@PostMapping("/elimina")
	public String eliminaRegista(@RequestParam(name = "idRegista") Long idRegista,
			RedirectAttributes redirectAttrs, HttpServletRequest request) {

		if(registaService.caricaSingoloElemento(idRegista).getFilms().size()>0) {
			redirectAttrs.addFlashAttribute("errorMessage", "Impossibile rimuovere un regista che ha dei film associati");
			return "redirect:/regista";
		}
